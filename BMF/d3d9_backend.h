...
class BMF_IDirect3D9 : public IDirect3D9
{
public:
  BMF_IDirect3D9 (IDirect3D9* pImpl) : d3d9_ (pImpl) {
    //refs_ = 1;
  }

  virtual ~BMF_IDirect3D9 (void) {
    //Assert (refs_ == 0)
    //refs_ = 0;
  }
...
class BMF_IDirect3D9Ex : public BMF_IDirect3D9
{
public:
  BMF_IDirect3D9Ex (IDirect3D9Ex* pImpl) : BMF_IDirect3D9 (pImpl) {
  }

  virtual ~BMF_IDirect3D9Ex (void) {
    //Assert (refs == 0)
  }
